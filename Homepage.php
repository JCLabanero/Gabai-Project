...
<body style="overflow-x: hidden; overflow-y: auto; font-family:Roboto;" onkeydown="">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <div class="text-end mx-3">
        ...
        <button type="button" class="btn  logn " data-bs-toggle="modal" data-bs-target="#register" style="font-family:Roboto; background:#542C0C;">
          SIGN UP</button>
        <!-- Login Modal -->
        <div class="modal fade" id="login" tabindex="-1" aria-labelledby="modal" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
            <div class="modal-content shadow mdlbg">
              <div class="modal-header p-5 pb-4 border-bottom-0 text-center">
                ...
                <h1 class="fw-bold mb-0 fs-1">Sign In</h1>
              ...
              <div class="modal-body p-5 pt-0">
                <form class="" method="POST" action="">
                  ...
                  <div class="form-floating mb-3">
                    <p class="text-danger" id="error-message">Danger</p>
                  </div>
                  <div class="form-floating mb-3">
  ...
  <div class="modal fade" id="register" tabindex="-1" aria-labelledby="modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content shadow mdlbg ">
        <div class="modal-header p-5 pb-4 border-bottom-0 text-center">
          <!-- <h1 class="modal-title fs-5" >Modal title</h1> -->
